...
?>
<h1><?php _e('How to use the free version', 'embedder-for-google-reviews'); ?></h1>
<ol>
    <li><?php _e('Enter your business name', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Click \'Search business\'', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Choose your business from the list', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Choose your preferred language', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Click the \'Pull reviews\' button', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Wait until the process is finished. The page will refresh automatically', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Now you should already see your reviews. If not, click the \'Pull reviews\' button again', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Hit \'save\'', 'embedder-for-google-reviews'); ?></li>
    <li><?php _e('Use one of the shortcodes in order to display your reviews on pages, posts, Elementor, Beaver Builder, Bakery Builder etc.', 'embedder-for-google-reviews'); ?></li>
    <li>
		<?php
		echo
		wp_kses(
...
<h1 style="display: block;"><?php _e('Video tutorial', 'embedder-for-google-reviews'); ?></h1>
